...
describe("Post", () => {
  ...
  describe("#create()", () => {
    it("should create a post object with a title, body, and assigned topic and user", done => {
      Post.create({
        ...
        expect(post.topicId).toBe(this.topic.id); //new in checkpoint-auth but should've been here already?
    ...
    it("should not create a post with missing title, body, or assigned topic", done => {
      Post.create({
        ...
        .then(post => {
          //validation error will skip this code block and not eval it; we'll catch error in the catch and set expectations there
          done();
        })
        .catch(err => {
  ...
  describe("#getPoints()", () => {
    it("should return the total number of votes for a post", done => {
      this.post.votes = [];
